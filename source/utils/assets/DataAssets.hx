...
// JOELwindows7: yoink from https://github.com/EnigmaEngine/EnigmaEngine/blob/stable/source/funkin/util/assets/DataAssets.hx
// here are data asset utilities for it that Enigma. the Load JSON e.g. utilizes TJSON wow!
/*
 * DataAssets.hx
