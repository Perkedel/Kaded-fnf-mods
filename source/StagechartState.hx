...
//JOELwindows7: inspire from ModChartState.hx
#if ((windows || linux) && cpp) //LuaJit only works for C++ 
class StageScriptState {
    ...
    public static function createModchartState():StageScriptState
    {
        return new StageScriptState();
    }
}
#end