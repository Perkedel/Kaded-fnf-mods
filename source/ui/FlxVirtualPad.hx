//JOELwindows7: yoink from luckydog7's android port which this itself yoinked
// from the official FlxVirtualPad.hx .
	...
	public function new(?DPad:FlxDPadMode, ?Action:FlxActionMode)
	{
		...
		switch (Action)
		{
			...
			case A_B_X_Y:
				...
				//JOELwindows7: breaking the A B X Y so it looks like so that.
				actions.add(add(buttonY = createButton(FlxG.width - 86 * 3, FlxG.height - 66 - 116 * 3, 44 * 3, 45 * 3, "y")));
				actions.add(add(buttonX = createButton(FlxG.width - 130 * 3, FlxG.height - 66 - 81 * 3, 44 * 3, 45 * 3, "x")));
				actions.add(add(buttonB = createButton(FlxG.width - 44 * 3, FlxG.height - 66 - 81 * 3, 44 * 3, 45 * 3, "b")));
				actions.add(add(buttonA = createButton(FlxG.width - 86 * 3, FlxG.height - 66 - 45 * 3, 44 * 3, 45 * 3, "a")));
			case NONE: // do nothing
		}
	}
